...
class FaceEncodingController extends Controller
{
    ...
    public function registerFace(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->file('images') as $i => $img) {
                ...
                $imagesStore[] = [
                    'id' => $i + 1,
                    // 'image_path' => 'storage/assets/images/users/face_images/' . $filename,
    ...
    //         return response()->json([
    //             'status' => false,
    //             'message' => 'Kamu tidak bisa presensi di luar jam yang ditentukan.'
    //         ]);
    //     }
    ...
    //     return response()->json([
    //         'status' => true,
    //         'message' => 'Presensisi ' . $tipe . ' berhasil' . ($isLate ? ', namun kamu terlambat.' : '.'),
    //         'late' => $isLate
    //     ]);
    // }
}
