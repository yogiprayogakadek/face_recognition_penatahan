...
class RuleController extends Controller
{
    ...
    public function store(RuleRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('rule.index')->with('success', 'Aturan presensi berhasil disimpan.');
        } catch (\Throwable $th) {
            report($th);
    ...
    public function update(RuleRequest $request, $role_group_id)
    {
        ...
        try {
            ...
            return redirect()->route('rule.index')->with('success', 'Aturan presensi berhasil diperbarui.');
        } catch (\Throwable $th) {
            report($th);
