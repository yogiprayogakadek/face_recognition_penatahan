...
@section('content')
        ...
        <div class="col-12">
            <div class="card chart-card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="mb-0 fw-bold"><i class="ti ti-chart-area-line me-2 text-primary"></i>Grafik Tren Presensi
                    </h5>
    ...
    <div class="row mt-4">
        <div class="col-12 mb-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold"><i class="ti ti-pie-chart me-2 text-primary"></i>Ringkasan Presensi Hari Ini</h5>
        ...
        <div class="col-lg-6">
            <div class="card chart-card">
                <div class="card-header">
                    <h6 class="mb-0 fw-semibold">Distribusi Presensi Masuk</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card chart-card">
                <div class="card-header">
                    <h6 class="mb-0 fw-semibold">Distribusi Presensi Pulang</h6>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#exportChart').on('click', () => areaChart.dataURI().then(({
                imgURI
            }) => downloadURI(imgURI, 'grafik-tren-presensi.png')));
