...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <i class="ti ti-chart-area me-2"></i>Grafik Presensi
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <i class="ti ti-chart-donut me-2"></i>Distribusi Presensi Masuk Hari Ini
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <i class="ti ti-chart-donut me-2"></i>Distribusi Presensi Pulang Hari Ini
                </div>
                <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            $('#exportChart').on('click', function() {
                areaChart.dataURI().then(({
                    ...
                    link.download = 'chart-presensi.png';
                    link.href = imgURI;
                    link.click();
                });
            });
