    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">
                {{ !auth()->user()->pegawai->faceEncoding ? 'Pendaftaran' : 'Update' }} Data Wajah
            </h5>
...
@push('script')
    ...
    <script>
        ...
        let pegawaiID = '{{ auth()->user()->pegawai->id }}';
        const maxImages = 5;
        ...
        Promise.all([
            ...
            if ("{{ auth()->user()->pegawai->faceEncoding }}") {
                Swal.fire("info", "Data wajah anda sudah ada, ini akan mengubah data wajah anda.", "warning");
            }
            startVideo();
        });
