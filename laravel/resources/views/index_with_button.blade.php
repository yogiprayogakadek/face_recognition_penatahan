...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white flex items-center justify-center">
    ...
    <div class="w-full max-w-4xl p-4 flex flex-col h-full items-center justify-between">
        ...
        <div class="text-center space-y-1">
            <h1 class="text-3xl font-bold text-blue-700 dark:text-blue-400">📸 Presensi Wajah</h1>
    ...
    <script>
                ...
                fetch("{{ route('face.verify') }}", {
                    ...
                    .then(data => {
                        ...
                        if (isSuccess) {
                            ...
                            speak(data.message ?? "Presensi gagal. Silakan coba lagi.", femaleVoice);
        ...
        function checkPresensiStatus() {
            ...
            for (const rule of rules) {
                ...
                if (currentTime >= startMin && currentTime <= endMin) {
                    ...
                    statusEl.textContent = '🟢 Silakan presensi sekarang (' + rule.tipe + ')';
            ...
            statusEl.textContent = '🔴 Di luar jam presensi';
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            checkPresensiStatus();
            setInterval(checkPresensiStatus, 10000);
